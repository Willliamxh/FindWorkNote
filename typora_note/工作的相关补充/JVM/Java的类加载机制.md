...
类从被加载到虚拟机内存到被卸载，整个完整的生命周期包括：**类加载、验证、准备、解析、初始化、使用和卸载**七个阶段。其中**验证，准备，解析**三个部分统称为连接。接下来我们可以详细了解下类加载的各个过程。

![img](Java的类加载机制.assets/v2-ecf6c3d0f5146029e9693d6223d23afb_b.jpg)

作者：程序猿刘先森
链接：https://zhuanlan.zhihu.com/p/33509426
来源：知乎
