...
```bash
# nameserver
10.193.179.236 rocketmq-nameserver1
10.193.179.233 rocketmq-nameserver2
# broker
10.193.179.236 rocketmq-master1
10.193.179.236 rocketmq-slave2
10.193.179.233 rocketmq-master2
10.193.179.233 rocketmq-slave1
```
...
分别在10.193.179.236和10.193.179.233启动NameServer
...
* 在10.193.179.236上启动master1和slave2
...
* 在10.193.179.233上启动master2和slave2
...
```sh
rocketmq.config.namesrvAddr=10.193.179.236:9876;10.193.179.233:9876
```
...
public class Producer {
    public static void main(String[] args) throws MQClientException, InterruptedException {
        ...
        producer.setNamesrvAddr("10.193.179.236:9876;10.193.179.233:9876");
        //生产者这是监听器
