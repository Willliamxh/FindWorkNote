...
大多数都是通过工厂+策略去实现。但是我这边更偏向于门面。

![image-20230830172823441](/Users/xuhan/Documents/workNote/FindWorkNote/typora_note/相关学习/设计模式之美/2.设计原则与思想：面相对象/09 | 理论六：为什么基于接口而非实现编程？有必要为每个类都定义接口吗？.assets/image-20230830172823441.png)