...
1. 取决于 IdGenerator.generateTransactionId 的实现。如果其依赖了数据库或者二方三方RPC服务，那么为了方便编写单元测试应该对其做 mock，以便减少数据库或者服务不可控对测试的影响；否则不需要 mock

![image-20230912174355458](/Users/xuhan/Documents/workNote/FindWorkNote/typora_note/相关学习/设计模式之美/4.设计原则与思想：规范与重构(11节)/29 | 理论三：什么是代码的可测试性？如何写出可测试性好的代码？.assets/image-20230912174355458.png)